...
plt.annotate('Slow-roll end at N = %.3f' % (Nfolds[index]), xy=(Nfolds[index], epsilon[index]), xytext=(54.3, -0.7), bbox=dict(boxstyle="square", fc="w"), arrowprops=dict(facecolor='black', shrink=0.05))
plt.annotate('Inflation condition end at N = %.3f' % (Nfolds[index2]), xy=(Nfolds[index2], InflationCondition[index2]), xytext=(55.7, -2.5), bbox=dict(boxstyle="square", fc="w"), arrowprops=dict(facecolor='black', shrink=0.05))
